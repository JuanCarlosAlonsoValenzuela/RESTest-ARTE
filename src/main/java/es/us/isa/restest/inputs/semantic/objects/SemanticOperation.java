...
public class SemanticOperation {
    ...
    // This functions returns all the operations containing a a "predicates" gen parameter and a "numberOfTriesToGenerateRegex" gen parameter (i.e., parameters with values generated by ARTE)
                        ...
                        if (generator.getType().equals(RANDOM_INPUT_VALUE)) {
                            ...
                            for (GenParameter genParameter : genParameters) {
                                ...
                                if (genParameter.getName().equals(PREDICATES)) {
                                    ...
                                    // Add only if there is also a property called numberOfTriesToGenerateRegex
                                    boolean numberOfTriesIsPresent = genParameters.stream().anyMatch(x->x.getName().equals(NUMBER_OF_TRIES_TO_GENERATE_REGEX));
                                    if(numberOfTriesIsPresent){
